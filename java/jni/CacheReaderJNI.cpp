 ...
 */
extern "C" JNIEXPORT jint JNICALL Java_com_applovin_axoncache_CacheReader_nativeContainsKey( JNIEnv * env, jobject obj, jlong handle, jbyteArray key, jint keySize )
{
    CacheReaderHandle * readerHandle = reinterpret_cast<CacheReaderHandle *>( handle );
 ...
 * Method:    nativeGetKey
 */
extern "C" JNIEXPORT jstring JNICALL Java_com_applovin_axoncache_CacheReader_nativeGetKey( JNIEnv * env, jobject obj, jlong handle, jbyteArray key, jint keySize )
{
    CacheReaderHandle * readerHandle = reinterpret_cast<CacheReaderHandle *>( handle );
    jbyte * keyBytes = env->GetByteArrayElements( key, nullptr );
    int isExist = 0;
 ...
 */
extern "C" JNIEXPORT jlong JNICALL Java_com_applovin_axoncache_CacheReader_nativeGetLong( JNIEnv * env, jobject obj, jlong handle, jbyteArray key, jint keySize, jlong defaultValue )
{
    CacheReaderHandle * readerHandle = reinterpret_cast<CacheReaderHandle *>( handle );
    jbyte * keyBytes = env->GetByteArrayElements( key, nullptr );
    int isExist = 0;
 ...
 */
extern "C" JNIEXPORT jint JNICALL Java_com_applovin_axoncache_CacheReader_nativeGetInteger( JNIEnv * env, jobject obj, jlong handle, jbyteArray key, jint keySize, jint defaultValue )
{
    CacheReaderHandle * readerHandle = reinterpret_cast<CacheReaderHandle *>( handle );
    jbyte * keyBytes = env->GetByteArrayElements( key, nullptr );
    int isExist = 0;
 ...
 */
extern "C" JNIEXPORT jdouble JNICALL Java_com_applovin_axoncache_CacheReader_nativeGetDouble( JNIEnv * env, jobject obj, jlong handle, jbyteArray key, jint keySize, jdouble defaultValue )
{
    CacheReaderHandle * readerHandle = reinterpret_cast<CacheReaderHandle *>( handle );
    jbyte * keyBytes = env->GetByteArrayElements( key, nullptr );
    int isExist = 0;
 ...
 */
extern "C" JNIEXPORT jint JNICALL Java_com_applovin_axoncache_CacheReader_nativeGetBool( JNIEnv * env, jobject obj, jlong handle, jbyteArray key, jint keySize, jint defaultValue )
{
    CacheReaderHandle * readerHandle = reinterpret_cast<CacheReaderHandle *>( handle );
    jbyte * keyBytes = env->GetByteArrayElements( key, nullptr );
    int isExist = 0;
 ...
 */
extern "C" JNIEXPORT jobjectArray JNICALL Java_com_applovin_axoncache_CacheReader_nativeGetVector( JNIEnv * env, jobject obj, jlong handle, jbyteArray key, jint keySize )
{
    CacheReaderHandle * readerHandle = reinterpret_cast<CacheReaderHandle *>( handle );
    jbyte * keyBytes = env->GetByteArrayElements( key, nullptr );
    int vectorSize = 0;
 ...
 */
extern "C" JNIEXPORT jfloatArray JNICALL Java_com_applovin_axoncache_CacheReader_nativeGetFloatVector( JNIEnv * env, jobject obj, jlong handle, jbyteArray key, jint keySize )
{
    CacheReaderHandle * readerHandle = reinterpret_cast<CacheReaderHandle *>( handle );
    jbyte * keyBytes = env->GetByteArrayElements( key, nullptr );
    int vectorSize = 0;
 ...
 */
extern "C" JNIEXPORT jint JNICALL Java_com_applovin_axoncache_CacheReader_nativeGetVectorKeySize( JNIEnv * env, jobject obj, jlong handle, jbyteArray key, jint keySize )
{
    CacheReaderHandle * readerHandle = reinterpret_cast<CacheReaderHandle *>( handle );
    jbyte * keyBytes = env->GetByteArrayElements( key, nullptr );
 ...
 */
extern "C" JNIEXPORT jstring JNICALL Java_com_applovin_axoncache_CacheReader_nativeGetVectorKey( JNIEnv * env, jobject obj, jlong handle, jbyteArray key, jint keySize, jint index )
{
    CacheReaderHandle * readerHandle = reinterpret_cast<CacheReaderHandle *>( handle );
    jbyte * keyBytes = env->GetByteArrayElements( key, nullptr );
    int valueSize = 0;
 ...
 */
extern "C" JNIEXPORT jstring JNICALL Java_com_applovin_axoncache_CacheReader_nativeGetKeyType( JNIEnv * env, jobject obj, jlong handle, jbyteArray key, jint keySize )
{
    CacheReaderHandle * readerHandle = reinterpret_cast<CacheReaderHandle *>( handle );
    jbyte * keyBytes = env->GetByteArrayElements( key, nullptr );
    int valueSize = 0;
