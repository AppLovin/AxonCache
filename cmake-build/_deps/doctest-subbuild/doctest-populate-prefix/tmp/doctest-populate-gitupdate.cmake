...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "v2.4.12"
  WORKING_DIRECTORY "/Users/erolkeskiner/Playground/bidderserver-bazelification/AxonCache/cmake-build/_deps/doctest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/erolkeskiner/Playground/bidderserver-bazelification/AxonCache/cmake-build/_deps/doctest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/erolkeskiner/Playground/bidderserver-bazelification/AxonCache/cmake-build/_deps/doctest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
